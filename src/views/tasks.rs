        ...
        app.tasks
            ...
            .map(|t| {
                let list_item = match t {
                    meilisearch_sdk::Task::Enqueued { content } => ListItem::new(vec![
                        Line::from(vec![
                    ...
                    meilisearch_sdk::Task::Processing { content } => ListItem::new(vec![
                        Line::from(vec![
                            Span::styled(format!(" {} ", content.uid), Style::default()),
                            Span::styled(
                                format!("{} ", get_task_type_name(&content.update_type)),
                    ...
                    meilisearch_sdk::Task::Failed { content } => ListItem::new(vec![
                        Line::from(vec![
                    ...
                    meilisearch_sdk::Task::Succeeded { content } => ListItem::new(vec![
                        Line::from(vec![
                            Span::styled(format!(" {} ", content.uid), Style::default()),
                            Span::styled(
                                format!("{} ", get_task_type_name(&content.update_type)),
